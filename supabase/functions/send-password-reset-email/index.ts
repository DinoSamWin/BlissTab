...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const isZh = lang === 'zh';
    const subject = isZh ? '✦ 重置您的 StartlyTab 密码' : '✦ Reset your password for StartlyTab';
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 500px; border-collapse: collapse;">
                ...
                <tr>
                  <td style="color: #1a1a1a; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 16px; line-height: 26px; padding-bottom: 32px;">
                    ...
                    <p style="margin: 0 0 20px 0;">We received a request to reset your password for your StartlyTab account. If you didn't make this request, you can safely ignore this email.</p>
                    <p style="margin: 0 0 40px 0;">To set a new password and return to your mindful workspace, please click the button below:</p>
                    
                    <!-- Robust Black Button -->
                    <table border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center" style="border-radius: 6px;" bgcolor="#000000">
                          <a href="${customResetLink}" target="_blank" style="font-size: 15px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; color: #ffffff !important; text-decoration: none; padding: 14px 28px; border-radius: 6px; font-weight: 600; display: inline-block; background-color: #000000; border: 1px solid #000000; -webkit-text-fill-color: #ffffff;">Reset my password</a>
                        </td>
                      </tr>
                    </table>
                  </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td style="color: #4b5563; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 14px; line-height: 20px; padding-bottom: 24px;">
                          If you have any questions or need further assistance, our team is ready to help.
                        </td>
                      </tr>
                      <tr>
                        <td align="left">
