            ...
            <div className="w-full max-w-7xl">
                ...
                >
                    <div className="overflow-hidden h-[200px] px-6 py-6 md:px-8 md:py-8 relative rounded-[2rem]">
                        ...
                        {links.length > 0 && (
                            <div className={`
                            absolute bottom-6 left-1/2 -translate-x-1/2 pointer-events-auto cursor-pointer
                        ...
                        `}
                            ...
                            >
                                <div className="bg-gray-900/90 dark:bg-white/90 backdrop-blur text-white dark:text-gray-900 text-[10px] font-bold px-4 py-2 rounded-full shadow-xl flex items-center gap-2 whitespace-nowrap border border-white/10 dark:border-black/5 hover:scale-105 transition-transform">
                                    <span>Expand</span>
                                </div>
                            </div>
                        )}
