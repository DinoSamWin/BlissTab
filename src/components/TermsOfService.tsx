        ...
        <div className="min-h-screen bg-gray-50 dark:bg-[#0F0F0F] text-gray-800 dark:text-gray-200 p-8 md:p-16">
            <div className="max-w-3xl mx-auto space-y-8 animate-reveal">
                ...
                <section className="space-y-4">
                    ...
                    <p>By accessing StartlyTab.com or installing the StartlyTab Chrome Extension ("the Service"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Service.</p>
                    <p>StartlyTab is a browser start-page application designed to provide a mindful workspace with AI-assisted focus tools and customizable gateway shortcuts.</p>
                </section>

                <section className="space-y-4">
                    <h2 className="text-2xl font-semibold">2. Browser Extension Specifics</h2>
                    <p>When you install the StartlyTab Chrome Extension, the Service will override your default "New Tab" page. You can restore your original browser settings at any time by disabling or removing the extension via your browser's extension management page.</p>
                    <p>The Extension requires certain permissions (such as Bookmarks or Tabs) to provide core functionality, including shortcut importing and search capabilities. We do not use these permissions to track your browsing history or collect sensitive personal information.</p>
                </section>

                <section className="space-y-4">
                    <h2 className="text-2xl font-semibold">3. AI Wrapper Disclosure & Disclaimer</h2>
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl font-semibold">6. User Conduct and Responsibilities</h2>
